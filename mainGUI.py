...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # self.ui.liveCam.clicked.connect(self.liveDetect)
    ...
    #         while True:
    #             self.test_final =  "python {}\yolov5-master\detect.py --weights best.pt --conf 0.5 --img 416 --source 0 ".format(self.p)
    #             os.system(self.test_final)

    #     except KeyboardInterrupt:
    #         print("Quiting Live Camera")
    ...
    def run(self):
        ...
        # self.test_final =  "python {}\yolov5-master\detect.py --weights best.pt --conf 0.5 --img 416 --source {} --name {}".format(self.p, self.test_src_path, self.output_name)
        # os.system(self.test_final)
